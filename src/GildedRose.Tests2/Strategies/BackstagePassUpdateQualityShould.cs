...
{
    public class BackstagePassUpdateQualityShould : BaseStrategyTest
    {
        readonly BackstagePassUpdateQualityStrategy _strategy = new BackstagePassUpdateQualityStrategy();
